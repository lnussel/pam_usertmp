...
MYCFLAGS = -Werror-implicit-function-declaration -MD
...
pam_usertmp.o: pam_usertmp.c
	$(CC) $(CFLAGS) $(MYCFLAGS) $(CPPFLAGS) $(TARGET_ARCH) -fPIC -c -o $@ $<

pam_usertmp.so: pam_usertmp.o
	$(CC) $(CFLAGS) $(MYCFLAGS) $(CPPFLAGS) $(TARGET_ARCH) -o $@ -fPIC -shared -Wl,-z,defs $? $(LDLIBS)
